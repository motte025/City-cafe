...
export function settingsForm(){return `<div class="settings-grid">
 ...
 </div><p>Ab dem nächsten Wurf. Die Kugel wird physikalisch simuliert (Schwerkraft, Drall, Stöße, Roll- und Luftwiderstand); jeder Wurf verläuft anders. Einlauf = Taschen, die die Kugel ab dem ersten Kontakt mit dem Taschenkranz noch wandert. Referenz: 21 mm / 8,7 g Ivorine.</p></details>
